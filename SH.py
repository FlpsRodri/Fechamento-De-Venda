...
class aplicativo():
    ...
    def __init__(self):
        ...
        if a != ".sql" or b != ".sql":
            self.window.destroy()
            erro = messagebox.askokcancel(
                title="Falha de Banco de Dados",
                message=
                "ENCONTRADO ERRO NO BANCO DE DADOS! \n CHAMAR ASSISTENCIA TÉCNICA."
            )
            atcnica = messagebox.askyesno(
                title="ERRO", message="Confirmar ir à area de restauração")
            if atcnica:
                ast = Tk()
        ...
        self.btnfechamento = Button(self.window,
                                    text="Fechamento de caixa",
                                    font=self.fontebotao,
                                    width=23,
                                    bg="yellow",
                                    command=self.fechamento)
        self.btnfechamento.pack(anchor=CENTER, pady=2)
        self.btnfechamento.focus()
        self.btncont = Button(self.window,
                              text="Contar dinheiro",
                              bg="yellow",
                              width=23,
                              height=1,
                              font=self.fontebotao,
                              command=self.contarDinheiro)
        self.btncont.pack(anchor=CENTER, pady=2)
        self.btnfechar = Button(self.window,
                                text="Fechar",
                                bg="yellow",
                                width=23,
                                height=1,
        ...
        self.btnadmin = Button(self.window,
                               text="Administrativo",
                               width=23,
                               height=1,
                               font="arial 11 bold",
    ...
    def diretorios(self):
        ...
        with open(r"c:\FLPrograms\Read\Config\Texts\Impressora padrao.txt",
                  "r") as printer:
    ...
    def DB(self):
        ...
        try:
            self.bankgastos = sqlite3.connect(
                "c:\FLPrograms\DBGastosSupermercado Hely.sql")
        except:
            alert = messagebox.askretrycancel(
                title="ERRO GRAVE",
                message=
                "FALHA NO CARREGAMETO DO BANCO DE DADOS COD(db0sph0-g) \nCONTATAR SUPORTE TECNICO: felipedsrodrigues@outlook.com"
            )
            if alert == True:
                return DB()
        try:
            self.bankfechamento = sqlite3.connect(
                "C:\FLPrograms\DBSupermercado Hely.sql")
        except:
            alert = messagebox.askretrycancel(
                title="ERRO GRAVE",
                message=
                "FALHA NO CARREGAMETO DO BANCO DE DADOS COD(db0sph0-f) \nCONTATAR SUPORTE TECNICO: felipedsrodrigues@outlook.com"
            )
            if alert == True:
                return DB()
        ...
        self.cursorfechamento.execute(
            "CREATE TABLE IF NOT EXISTS fechamento(idcontrole integer primary key autoincrement ,dia text ,caixa text,  dinheiro float, cartao float, aprazo float , pix float , gastos float , supervisor text,senha text, impressora text) "
        )
        self.cursorgastos.execute(
            "CREATE TABLE IF NOT EXISTS gastos(idcontrole integer primary key autoincrement ,dia text , gastosSemRetorno text ,valorSR float , gastosComRetorno text , valorCR float , funcionario text) "
        )
    ...
    def fechamento(self):
        ...
        self.btnvoltar = Button(self.window1,
                                text="Voltar",
                                command=self.voltar)
        self.btnvoltar.place(x=2, y=2)

        self.titulo = Label(self.window1,
                            text="FECHAMENTO DE CAIXA",
                            bg="red",
                            font=self.fontetitulo)
        self.titulo.place(x=250, y=20)

        self.lblcx = Label(self.window1,
                           text="CX",
                           width=3,
                           relief="solid",
                           bd=1,
        ...
        if self.mesatual < 10 and self.diaatual < 10:
            self.txtdia.insert(
                0, '0' + str(self.datual.day) + "/" + '0' +
                str(self.datual.month) + "/" + str(self.datual.year))
        elif self.mesatual < 10:
            self.txtdia.insert(
                0,
                str(self.diaatual) + "/" + '0' + str(self.mesatual) + "/" +
                str(self.datual.year))
        elif self.diaatual < 10:
            self.txtdia.insert(
                0, '0' + str(self.datual.day) + "/" + str(self.datual.month) +
                "/" + str(self.datual.year))
        else:
            self.txtdia.insert(
                0,
                str(self.datual.day) + "/" + str(self.datual.month) + "/" +
                str(self.datual.year))

        self.dmanha = Label(self.window1,
                            text="Dinheiro da Manhã",
                            width=20,
                            anchor=W,
                            font=self.fonteLabel,
                            bd=1,
        ...
        self.dtarde = Label(self.window1,
                            text="Dinheiro da Tarde",
                            anchor=W,
                            font=self.fonteLabel,
                            bd=1,
                            relief="solid",
        ...
        with open(r"c:\FLPrograms\Read\Config\Texts\Tarde.txt",
                  'r') as arquivo:
            for row in arquivo:
        ...
        if self.valortarde > 0:
            self.txtarde1 = Label(self.window1,
                                  text=f"{self.valortarde}",
                                  bd=1,
                                  anchor=E,
                                  width=9,
                                  font=self.fonteLabel,
        ...
        self.sistem = Label(self.window1,
                            text="Saldo Total",
                            width=20,
                            anchor=W,
                            bd=1,
        ...
        self.botao = Button(self.window1,
                            text="Confirmar",
                            width=8,
                            bg="yellow",
                            height=1,
    ...
    def calculo(self):
        ...
        self.somatotal = (self.dinheirototal + self.cartao + self.aprazo +
                          self.pix)
        self.saldof = self.somatotal - self.sistema
        self.saldofinal = format(self.saldof, '.2f')

        self.lin1 = Label(self.window1,
                          text=f"CX {self.cx}",
                          width=15,
                          font=self.fonteLabel)
        self.lin1.place(x=400, y=100)

        self.lin2 = Label(self.window1,
                          text="Dinheiro da Manhã",
                          font=self.fonteLabel,
                          bg="#ffff00",
                          width=20,
        ...
        self.lin22 = Label(self.window1,
                           text=f" {format(self.dinheiromanha , '.2f') }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           relief='solid',
        ...
        self.lin33 = Label(self.window1,
                           text=f"+  {format(self.dinheirotarde , '.2f') }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           relief='solid',
        ...
        self.lin44 = Label(self.window1,
                           text=f"{format(self.dinheirocsuprimento , '.2f') }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           relief='solid',
        ...
        self.lin55 = Label(self.window1,
                           text=f"-  {format(self.suprimento , '.2f') }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           relief='solid',
        ...
        self.lin66 = Label(self.window1,
                           text=f"{format(self.dinheirototal , '.2f') }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           relief='solid',
        ...
        self.lin77 = Label(self.window1,
                           text=f"{format(self.cartao , '.2f' ) }",
                           font=self.fonteLabel,
                           width=10,
                           bg="#ffff00",
                           bd=1,
        ...
        self.lin88 = Label(self.window1,
                           text=f"{format(self.aprazo , '.2f' ) }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           bg="#ffff00",
        ...
        self.lin99 = Label(self.window1,
                           text=f"+  {format(self.pix , '.2f' ) }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           bg="#ffff00",
        ...
        self.lin91 = Label(self.window1,
                           text=f"{format(self.somatotal , '.2f') }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           relief='solid',
        ...
        self.lin81 = Label(self.window1,
                           text=f"-  {format(self.sistema , '.2f') }",
                           font=self.fonteLabel,
                           width=10,
                           bd=1,
                           bg="#ffff00",
        ...
        if self.somatotal > self.sistema:
            self.lin71 = Label(self.window1,
                               text=f"{self.saldofinal }",
                               font=self.fonteLabel,
                               width=10,
                               bd=2,
                               bg="#00ff00",
        ...
        self.btnimprimir = Button(self.window1,
                                  text="Imprimir",
                                  background="yellow",
                                  font=self.fontebotao,
                                  width=8,
        ...
        with open(r'C:\FLPrograms\Read\Config\Texts\Fechamento impresso.txt',
                  'w') as arquivo:
            arquivo.write(
                str(f"""
-------------------------------------
...
"""))
    ...
    def imprimir(self):
        self.enviar = Button(self.window1,
                             text="Enviar",
                             font=self.fontebotao,
                             bg="yellow",
                             width=8,
    ...
    def guardar(self):
        ...
        confirm = messagebox.askyesno(
            ...
            message="Confirmar e Fechar Fechamento de caixa")
        ...
        if confirm:
            ...
            pix = self.pix
            self.cursorfechamento.execute(
                f"INSERT INTO fechamento (dia,caixa, dinheiro, cartao, aprazo, pix) VALUES ('{dia}','{caixa}',{dinheiro},{cartao},{aprazo},{pix} )"
            )
            self.bankfechamento.commit()
            self.window1.destroy()
    ...
    def contarDinheiro(self):
        ...
        self.lbl1 = Label(
            self.window2,
            text="Obs: Preencher com os valores totais somados de cada nota",
            font=self.fonteLabel,
            anchor=W,
            bd=1,
            relief="solid")
        self.lbl1.place(x=70, y=550)
        self.lbl2 = Label(self.window2,
                          text="Notas 200/100/50",
                          font=self.fonteLabel,
                          width=15,
                          bg="#ffff00",
                          bd=1,
    ...
    def confirmar(self):
        ...
        self.btnconfirmar = Button(self.jnl1,
                                   text="Logar",
                                   width=5,
                                   font="arial 13",
                                   bg="gray70",
    ...
    def verificar(self):
        ...
        with open(r'c:\FLPrograms\Read\Config\Texts\Users.txt',
                  'w') as usuario:
        ...
        for row in lista:
            ...
            if user == "felipe " and passwd == "FLProgram":
                ...
                versao = Label(jnl2,
                               text="Vesão 1.0/03.2022",
                               font="Times 12 bold",
                               width=20)
                versao.pack(anchor=CENTER)
                cntt = Label(
                    jnl2,
                    text="Contato: felipesrodrigs@gmail.com \n (97)984165908",
                    font="Times 12 bold",
                    width=30)
                cntt.pack(anchor=CENTER)
                btnfechar = Button(jnl2,
                                   text="Fechar",
                                   font="Times 12 bold",
                                   width=10,
                                   bg="#ffffff",
                                   command=jnl2.destroy)
    ...
    def Programador(self):
        ...
        btnprint = Button(self.jnl3,
                          text="Selecionar impressora padrão",
                          font=self.fontebotao,
                          bg="#4dc3ff",
                          width=25,
                          command=self.print_padrao)
        btnprint.pack(anchor=CENTER, pady=60)

        btnsupervisor = Button(self.jnl3,
                               text="Cadastrar novo Supervisor",
                               font=self.fontebotao,
                               bg="#4dc3ff",
                               width=25,
                               command=self.new_super)
        btnsupervisor.pack(anchor=CENTER, pady=2)

        btndb = Button(self.jnl3,
                       text="Cadastrar Servidor Local",
                       font=self.fontebotao,
                       bg="#4dc3ff",
                       width=25,
                       command=self.cadastrarservidor)
    ...
    def print_padrao(self):
        jnl4 = Tk()
        lblselect = Label(jnl4,
                          text="Selecione a Impressora padrão",
                          font="Arial 12",
                          anchor=CENTER,
                          width=30)
        lblselect.pack(pady=5)
        cb_print = ttk.Combobox(jnl4,
        ...
        def select():
            ...
            with open(r'c:\FLPrograms\Read\Config\Texts\Impressora padrao.txt',
                      'w') as impressorapadrao:
                impressorapadrao.write(cb_print.get())
                jnl4.destroy()

        btnconfirm = Button(jnl4,
    ...
    def new_super(self):
        ...
        def cadastrar():
            ...
            for nomes in supervisores:
                if nomes[0] == nome:
                    ...
                    repetido = messagebox.askyesno(
                        title="Usuario Repetido!",
                        message=
                        "Supervisor já cadastrado, \n deseja atualizar nova senha?"
                    )
                    if repetido:
                        self.cursorfechamento.execute(
                            f"UPDATE fechamento SET senha = '{senha}' WHERE supervisor = '{nome}'"
                        )
                        self.bankfechamento.commit()
                        jnl6.destroy()
                        break
                    ...
                    confirma = messagebox.askyesno(
                        title="",
                        message="Confirmar Inclusao de novo Supervisor ?")
                    if confirma:

                        self.cursorfechamento.execute(
                            f"INSERT INTO fechamento (supervisor , senha) VALUES ('{nome}','{senha}')"
                        )
                        self.bankfechamento.commit()
                        jnl6.destroy()
                        break
        ...
        def apagar():
            ...
            for name in supervir:
                if name[0] == nome:
                    ...
                    askdelete = messagebox.askyesno(title="!",
                                                    message="APAGAR USUARIO ?")
                    if askdelete:
                        self.cursorfechamento.execute(
                            f"DELETE FROM fechamento WHERE supervisor = '{nome}' "
                        )
                        self.bankfechamento.commit()
                        jnl6.destroy()
                        break
        ...
        btndelete = Button(jnl6,
                           text="Apagar Supervisor",
                           font="arial 12",
                           width=22,
                           bg="red",
                           command=apagar)
    ...
    def cadastrarservidor(self):
        ...
        alterar = messagebox.askyesno(
            title="Alterar Diretorios",
            message=
            "Selecionar Local dos Bancos de dados \n Fechamento \ Gastos")
        if alterar:
            localdbf = filedialog.askopenfilenames()[0]
            if localdbf != None:
                with open(r"c:\FLPrograms\Read\Config\Texts\Dbf.txt",
                          "w") as dbf:
                    dbf.write(localdbf)
            localdbg = filedialog.askopenfilenames()[0]
            if localdbg != None:
                with open(r"c:\FLPrograms\Read\Config\Texts\Dbg.txt",
                          "w") as dbg:
                    dbg.write(localdbg)
    ...
    def administrador(self):
        ...
        btnrelatorio = Button(jnl2,
                              text="Consultar Relatorios",
                              bg="#ff0",
                              width=20,
                              font=self.fonteLabel,
    ...
    def gerirgastos(self):
        ...
        if mesatual < 10 and diaatual < 10:
            edia.insert(
                0, '0' + str(datual.day) + "/" + '0' + str(datual.month) +
                "/" + str(datual.year))
        elif mesatual < 10:
            edia.insert(
                0,
                str(datual.day) + "/" + '0' + str(datual.month) + "/" +
                str(datual.year))
        elif diaatual < 10:
            edia.insert(
                0, '0' + str(datual.day) + "/" + str(datual.month) + "/" +
                str(datual.year))
        else:
            edia.insert(
                0,
                str(datual.day) + "/" + str(datual.month) + "/" +
                str(datual.year))

        lbldescricao1 = Label(jnl5,
                              text="Descrição gastos sem retorno",
                              width=30,
                              font="arial 12 bold",
                              bg="#fff")
        lbldescricao1.place(x=10, y=100)
        lbldescricao2 = Label(jnl5,
                              text="Descrição gastos com retorno",
                              width=30,
                              font="arial 12 bold",
                              bg="#fff")
        lbldescricao2.place(x=415, y=100)

        lbldescricao11 = Label(jnl5,
                               text="valor",
                               width=8,
                               font="arial 12 bold",
                               bg="#fff")
        lbldescricao11.place(x=312, y=100)
        lbldescricao22 = Label(jnl5,
                               text="valor",
                               width=8,
                               font="arial 12 bold",
                               bg="#fff")
        ...
        lbltotalsretornov = Label(jnl5,
                                  text="",
                                  font=fonte,
                                  width=10,
                                  bg="white")
        lbltotalsretornov.place(x=310, y=350)
        lbltotalcretorno = Label(jnl5,
                                 text="Total:",
                                 font=fonte,
                                 width=10,
                                 anchor=W,
        ...
        def calcular():
            ...
            for num in range(0, 10):
                ...
                if w[num] != "" and x[num] == "":
                    messagebox.showinfo(
                        title="ERRO",
                        message=f'ITEM "{w[num]}" SEM VALOR DESCRITO')
                else:
                ...
                if y[num] != "" and z[num] == "":
                    messagebox.showinfo(
                        title="ERRO",
                        message=f'ITEM "{y[num]}" SEM VALOR DESCRITO')
                else:
                    pass

                if w[num] == "" and x[num] != "":
                    messagebox.showinfo(
                        title="ERRO", message=f'ITEM "{x[num]}" SEM DESCRIÇÃO')
                else:
                    pass
                if y[num] == "" and z[num] != "":
                    messagebox.showinfo(
                        title="ERRO",
                        message=f'ITEM "{z[num]}" SEM VALOR DESCRIÇÃO')
                else:
                    pass
            ...
            def enviar():
                ...
                confirmacao = messagebox.askyesno(title="Confirmar",
                ...
                if confirmacao:
                    ...
                    if ts > 0:
                        for rows in range(0, ts):
                            ...
                            self.cursorgastos.execute(
                                f"INSERT INTO gastos (dia , gastosSemRetorno , valorSR,funcionario) VALUES ('{diaa}', '{dgs}', {vsr} , '{usuario}')"
                            )
                            self.bankgastos.commit()
                    ...
                    if tc > 0:
                        for value in range(0, tc):
                            ...
                            self.cursorgastos.execute(
                                f"INSERT INTO gastos (dia,gastosComRetorno,valorCR, funcionario) VALUES ('{diaa}', '{dgc}' , {vcr} , '{usuario}')"
                            )
                            self.bankgastos.commit()
    ...
    def relatorio(self):
        ...
        tvgastos = ttk.Treeview(tb1,
                                columns=("Dt", "dsg", "Vsr"),
                                show="headings")
        tventrada = ttk.Treeview(tb1,
                                 columns=("Dt", "din", "car", "pix"),
                                 show="headings")
        ...
        for row4 in self.lista:
            if row4[1] != None:
                ...
                if mes == mesatual and ano == anoatual and (row4[2] != None or
                                                            row4[4] != None):
                    if row4[2] != None:
                        description = row4[2]
                        money = row4[3]
        ...
        for dt in dias:
            ...
            tventrada.insert("",
                             "end",
                             values=(dt, moneys[idce], cards[idce],
                                     pixs[idce]))
        ...
        tve = ttk.Treeview(tb2,
                           columns=("data", "dinheiro", "cartao", "aprazo",
                                    "pix"),
                           show="headings")
        tv.place(x=10, y=100)
        ...
        def atualizar():
            ...
            tv2 = ttk.Treeview(tb2,
                               columns=("Dt", "Gsr", "Vsr"),
                               show="headings")
            tvc2 = ttk.Treeview(tb2,
                                columns=("Dt", "Gcr", "Vcr"),
                                show="headings")
            tve2 = ttk.Treeview(tb2,
                                columns=("data", "dinheiro", "cartao",
                                         "aprazo", "pix"),
                                show="headings")
            ...
            nmes = "0" + str(lista_meses.index(list_mes.get()) +
                             1) if lista_meses.index(
                                 list_mes.get()) < 9 else str(
                                     lista_meses.index(list_mes.get()) + 1)
            ...
            for item in self.lista:
                ...
                if nmes == mes and list_ano.get() == ano:
                    if item[2] != None:
                        ...
                        tv2.insert("",
                                   "end",
                                   values=(data, dgastosSR, vgastosSR))
                    ...
                    if item[4] != None:
                        ...
                        tvc2.insert("",
                                    "end",
                                    values=(data, dgastosCR, vgastosCR))
            ...
            for seg in self.listafechamento:
                if seg[1] != None:
                    ...
                    if nmes == mees and list_ano.get() == anoo:
                        ...
                        tve2.insert("",
                                    "end",
                                    values=(dte, vdin, vcard, vap, vpix))

            r_mensal = openpyxl.load_workbook(
                r"c:\FLPrograms\Read\R22M233.xlsx")
            ...
            for cell in sh_mensal.iter_rows(min_row=6, max_row=46):
                try:
                    ...
                    cell[
                        2].value = dgastsr[ind] if dgastsr[ind] != None else ""
                    cell[
                        3].value = vgastsr[ind] if vgastsr[ind] != None else ""
                    ind += 1
                except:
                    break
            ei = 0
            ...
            for cl in sh_mensal.iter_rows(min_row=6, max_row=36):
                try:
                    cl[10].value = ttpdia[4][eii] if ttpdia[4][
                        eii] != None else ""
                    cl[11].value = ttpdia[5][eii] if ttpdia[5][
                        eii] != None else ""
                    cl[12].value = ttpdia[6][eii] if ttpdia[6][
                        eii] != None else ""
                    cl[13].value = ttpdia[7][eii] if ttpdia[7][
                        eii] != None else ""
                    cl[14].value = ttpdia[8][eii] if ttpdia[8][
                        eii] != None else ""
                    eii += 1
                    if len(ttpdia[4]) == eii:
                        break
            ...
            for cels in sh_mensal.iter_rows(min_row=6, max_row=36):
                try:
                    ...
                    break
            r_mensal.save(
                f"c:\FLPrograms\Relatorios\Relatorio Mensal {list_mes.get()} {ano}.xlsx"
            )
            ...
            btnimprimir = Button(
                ...
                bg="#4dc3ff",
                font="arial 8",
                command=lambda: self.imprimir_relatorio(
                    f"Relatorio Mensal {list_mes.get()} {ano}.xlsx"))
            btnimprimir.place(x=707, y=65)

        btnatualizar = Button(tb2,
                              text="Atualizar",
                              font="arial 8",
                              bg="#4dc3ff",
                              command=atualizar)
        ...
        def bscar():
            ...
            self.bt_imprimir = Button(tb3,
                                      text="",
                                      font="arial 9",
                                      bg="#4dc3ff",
                                      command=lambda: self.imprimir_relatorio(
                                          f"Relatorio Anual {self.ano}.xlsx"))
            self.bt_imprimir.place(x=730, y=65)
            self.buscar_gastos()

        btnbuscar = Button(tb3,
                           text="Buscar",
                           font="arial 9",
                           bg="#4dc3ff",
                           command=bscar)
        ...
        self.lbltsaida = Label(tb3,
                               text="DESPESAS S RETORNO",
                               width=20,
                               bg="#ffff00",
                               bd=1,
                               relief="solid",
                               font=self.fonteLabel)
        self.lbltentrada = Label(tb3,
                                 text="TOTAL ENTRADAS",
                                 width=20,
                                 bg="#ffff00",
                                 bd=1,
                                 relief="solid",
                                 font=self.fonteLabel)
        self.lblttotal = Label(tb3,
                               text="SALDO FINAL DO ANO",
                               width=20,
                               bg="#ffff00",
                               bd=1,
                               relief="solid",
    ...
    def buscar_gastos(self):
        ...
        for item in self.lista:
            ...
            if self.l_anos.get() == ano:
                for cdmes in range(0, 12):
                    ...
                    cd_mes = ("0" + str(
                        (cdmes + 1))) if (cdmes + 1) < 10 else str((cdmes + 1))
        ...
        #GASTOS SEM RETORNO
        self.lblvjan["text"] = str(format(self.ttpmessr[0], ".2f")).replace(
            ".", ",") if self.ttpmessr[0] != 0 else "0,00"
        self.lblvfev["text"] = str(format(self.ttpmessr[1], ".2f")).replace(
            ".", ",") if self.ttpmessr[1] != 0 else "0,00"
        self.lblvmar["text"] = str(format(self.ttpmessr[2], ".2f")).replace(
            ".", ",") if self.ttpmessr[2] != 0 else "0,00"
        self.lblvabr["text"] = str(format(self.ttpmessr[3], ".2f")).replace(
            ".", ",") if self.ttpmessr[3] != 0 else "0,00"
        self.lblvmai["text"] = str(format(self.ttpmessr[4], ".2f")).replace(
            ".", ",") if self.ttpmessr[4] != 0 else "0,00"
        self.lblvjun["text"] = str(format(self.ttpmessr[5], ".2f")).replace(
            ".", ",") if self.ttpmessr[5] != 0 else "0,00"
        self.lblvjul["text"] = str(format(self.ttpmessr[6], ".2f")).replace(
            ".", ",") if self.ttpmessr[6] != 0 else "0,00"
        self.lblvago["text"] = str(format(self.ttpmessr[7], ".2f")).replace(
            ".", ",") if self.ttpmessr[7] != 0 else "0,00"
        self.lblvset["text"] = str(format(self.ttpmessr[8], ".2f")).replace(
            ".", ",") if self.ttpmessr[8] != 0 else "0,00"
        self.lblvout["text"] = str(format(self.ttpmessr[9], ".2f")).replace(
            ".", ",") if self.ttpmessr[9] != 0 else "0,00"
        self.lblvnov["text"] = str(format(self.ttpmessr[10], ".2f")).replace(
            ".", ",") if self.ttpmessr[10] != 0 else "0,00"
        self.lblvdez["text"] = str(format(self.ttpmessr[11], ".2f")).replace(
            ".", ",") if self.ttpmessr[11] != 0 else "0,00"
        self.lblttlsr["text"] = str(format(self.totalsr3,
                                           ".2f")).replace(".", ",")

        #GASTOS COM RETORNO
        self.lblcjan["text"] = str(format(self.ttpmescr[0], ".2f")).replace(
            ".", ",") if self.ttpmescr[0] != 0 else "0,00"
        self.lblcfev["text"] = str(format(self.ttpmescr[1], ".2f")).replace(
            ".", ",") if self.ttpmescr[1] != 0 else "0,00"
        self.lblcmar["text"] = str(format(self.ttpmescr[2], ".2f")).replace(
            ".", ",") if self.ttpmescr[2] != 0 else "0,00"
        self.lblcabr["text"] = str(format(self.ttpmescr[3], ".2f")).replace(
            ".", ",") if self.ttpmescr[3] != 0 else "0,00"
        self.lblcmai["text"] = str(format(self.ttpmescr[4], ".2f")).replace(
            ".", ",") if self.ttpmescr[4] != 0 else "0,00"
        self.lblcjun["text"] = str(format(self.ttpmescr[5], ".2f")).replace(
            ".", ",") if self.ttpmescr[5] != 0 else "0,00"
        self.lblcjul["text"] = str(format(self.ttpmescr[6], ".2f")).replace(
            ".", ",") if self.ttpmescr[6] != 0 else "0,00"
        self.lblcago["text"] = str(format(self.ttpmescr[7], ".2f")).replace(
            ".", ",") if self.ttpmescr[7] != 0 else "0,00"
        self.lblcset["text"] = str(format(self.ttpmescr[8], ".2f")).replace(
            ".", ",") if self.ttpmescr[8] != 0 else "0,00"
        self.lblcout["text"] = str(format(self.ttpmescr[9], ".2f")).replace(
            ".", ",") if self.ttpmescr[9] != 0 else "0,00"
        self.lblcnov["text"] = str(format(self.ttpmescr[10], ".2f")).replace(
            ".", ",") if self.ttpmescr[10] != 0 else "0,00"
        self.lblcdez["text"] = str(format(self.ttpmescr[11], ".2f")).replace(
            ".", ",") if self.ttpmescr[11] != 0 else "0,00"
        self.lblttlcr["text"] = str(format(self.totalcr3,
                                           ".2f")).replace(".", ",")

        #ENTRADA DINHEIRO
        self.lbdjan["text"] = str(format(self.totalpmesd[0], ".2f")).replace(
            ".", ",") if self.totalpmesd[0] != 0 else "0,00"
        self.lbdfev["text"] = str(format(self.totalpmesd[1], ".2f")).replace(
            ".", ",") if self.totalpmesd[1] != 0 else "0,00"
        self.lbdmar["text"] = str(format(self.totalpmesd[2], ".2f")).replace(
            ".", ",") if self.totalpmesd[2] != 0 else "0,00"
        self.lbdabr["text"] = str(format(self.totalpmesd[3], ".2f")).replace(
            ".", ",") if self.totalpmesd[3] != 0 else "0,00"
        self.lbdmai["text"] = str(format(self.totalpmesd[4], ".2f")).replace(
            ".", ",") if self.totalpmesd[4] != 0 else "0,00"
        self.lbdjun["text"] = str(format(self.totalpmesd[5], ".2f")).replace(
            ".", ",") if self.totalpmesd[5] != 0 else "0,00"
        self.lbdjul["text"] = str(format(self.totalpmesd[6], ".2f")).replace(
            ".", ",") if self.totalpmesd[6] != 0 else "0,00"
        self.lbdago["text"] = str(format(self.totalpmesd[7], ".2f")).replace(
            ".", ",") if self.totalpmesd[7] != 0 else "0,00"
        self.lbdset["text"] = str(format(self.totalpmesd[8], ".2f")).replace(
            ".", ",") if self.totalpmesd[8] != 0 else "0,00"
        self.lbdout["text"] = str(format(self.totalpmesd[9], ".2f")).replace(
            ".", ",") if self.totalpmesd[9] != 0 else "0,00"
        self.lbdnov["text"] = str(format(self.totalpmesd[10], ".2f")).replace(
            ".", ",") if self.totalpmesd[10] != 0 else "0,00"
        self.lbddez["text"] = str(format(self.totalpmesd[11], ".2f")).replace(
            ".", ",") if self.totalpmesd[11] != 0 else "0,00"
        self.lblttld["text"] = str(format(self.totaldinheiro,
                                          ".2f")).replace(".", ",")

        #ENTRADA CARTAO
        self.lbcjan["text"] = str(format(self.totalpmesc[0], ".2f")).replace(
            ".", ",") if self.totalpmesc[0] != 0 else "0,00"
        self.lbcfev["text"] = str(format(self.totalpmesc[1], ".2f")).replace(
            ".", ",") if self.totalpmesc[1] != 0 else "0,00"
        self.lbcmar["text"] = str(format(self.totalpmesc[2], ".2f")).replace(
            ".", ",") if self.totalpmesc[2] != 0 else "0,00"
        self.lbcabr["text"] = str(format(self.totalpmesc[3], ".2f")).replace(
            ".", ",") if self.totalpmesc[3] != 0 else "0,00"
        self.lbcmai["text"] = str(format(self.totalpmesc[4], ".2f")).replace(
            ".", ",") if self.totalpmesc[4] != 0 else "0,00"
        self.lbcjun["text"] = str(format(self.totalpmesc[5], ".2f")).replace(
            ".", ",") if self.totalpmesc[5] != 0 else "0,00"
        self.lbcjul["text"] = str(format(self.totalpmesc[6], ".2f")).replace(
            ".", ",") if self.totalpmesc[6] != 0 else "0,00"
        self.lbcago["text"] = str(format(self.totalpmesc[7], ".2f")).replace(
            ".", ",") if self.totalpmesc[7] != 0 else "0,00"
        self.lbcset["text"] = str(format(self.totalpmesc[8], ".2f")).replace(
            ".", ",") if self.totalpmesc[8] != 0 else "0,00"
        self.lbcout["text"] = str(format(self.totalpmesc[9], ".2f")).replace(
            ".", ",") if self.totalpmesc[9] != 0 else "0,00"
        self.lbcnov["text"] = str(format(self.totalpmesc[10], ".2f")).replace(
            ".", ",") if self.totalpmesc[10] != 0 else "0,00"
        self.lbcdez["text"] = str(format(self.totalpmesc[11], ".2f")).replace(
            ".", ",") if self.totalpmesc[11] != 0 else "0,00"
        self.lblttlc["text"] = str(format(self.totalcartao,
                                          ".2f")).replace(".", ",")

        #entrada pix e ticket
        self.lbpjan["text"] = str(format(self.totalpmesp[0], ".2f")).replace(
            ".", ",") if self.totalpmesp[0] != 0 else "0,00"
        self.lbpfev["text"] = str(format(self.totalpmesp[1], ".2f")).replace(
            ".", ",") if self.totalpmesp[1] != 0 else "0,00"
        self.lbpmar["text"] = str(format(self.totalpmesp[2], ".2f")).replace(
            ".", ",") if self.totalpmesp[2] != 0 else "0,00"
        self.lbpabr["text"] = str(format(self.totalpmesp[3], ".2f")).replace(
            ".", ",") if self.totalpmesp[3] != 0 else "0,00"
        self.lbpmai["text"] = str(format(self.totalpmesp[4], ".2f")).replace(
            ".", ",") if self.totalpmesp[4] != 0 else "0,00"
        self.lbpjun["text"] = str(format(self.totalpmesp[5], ".2f")).replace(
            ".", ",") if self.totalpmesp[5] != 0 else "0,00"
        self.lbpjul["text"] = str(format(self.totalpmesp[6], ".2f")).replace(
            ".", ",") if self.totalpmesp[6] != 0 else "0,00"
        self.lbpago["text"] = str(format(self.totalpmesp[7], ".2f")).replace(
            ".", ",") if self.totalpmesp[7] != 0 else "0,00"
        self.lbpset["text"] = str(format(self.totalpmesp[8], ".2f")).replace(
            ".", ",") if self.totalpmesp[8] != 0 else "0,00"
        self.lbpout["text"] = str(format(self.totalpmesp[9], ".2f")).replace(
            ".", ",") if self.totalpmesp[9] != 0 else "0,00"
        self.lbpnov["text"] = str(format(self.totalpmesp[10], ".2f")).replace(
            ".", ",") if self.totalpmesp[10] != 0 else "0,00"
        self.lbpdez["text"] = str(format(self.totalpmesp[11], ".2f")).replace(
            ".", ",") if self.totalpmesp[11] != 0 else "0,00"
        self.lblttlp["text"] = str(format(self.totalpix,
                                          ".2f")).replace(".", ",")

        #entrada total
        self.lbtjan["text"] = str(format(self.totalpmes[0], ".2f")).replace(
            ".", ",") if self.totalpmes[0] != 0 else "0,00"
        self.lbtfev["text"] = str(format(self.totalpmes[1], ".2f")).replace(
            ".", ",") if self.totalpmes[1] != 0 else "0,00"
        self.lbtmar["text"] = str(format(self.totalpmes[2], ".2f")).replace(
            ".", ",") if self.totalpmes[2] != 0 else "0,00"
        self.lbtabr["text"] = str(format(self.totalpmes[3], ".2f")).replace(
            ".", ",") if self.totalpmes[3] != 0 else "0,00"
        self.lbtmai["text"] = str(format(self.totalpmes[4], ".2f")).replace(
            ".", ",") if self.totalpmes[4] != 0 else "0,00"
        self.lbtjun["text"] = str(format(self.totalpmes[5], ".2f")).replace(
            ".", ",") if self.totalpmes[5] != 0 else "0,00"
        self.lbtjul["text"] = str(format(self.totalpmes[6], ".2f")).replace(
            ".", ",") if self.totalpmes[6] != 0 else "0,00"
        self.lbtago["text"] = str(format(self.totalpmes[7], ".2f")).replace(
            ".", ",") if self.totalpmes[7] != 0 else "0,00"
        self.lbtset["text"] = str(format(self.totalpmes[8], ".2f")).replace(
            ".", ",") if self.totalpmes[8] != 0 else "0,00"
        self.lbtout["text"] = str(format(self.totalpmes[9], ".2f")).replace(
            ".", ",") if self.totalpmes[9] != 0 else "0,00"
        self.lbtnov["text"] = str(format(self.totalpmes[10], ".2f")).replace(
            ".", ",") if self.totalpmes[10] != 0 else "0,00"
        self.lbtdez["text"] = str(format(self.totalpmes[11], ".2f")).replace(
            ".", ",") if self.totalpmes[11] != 0 else "0,00"
        self.lblttlt["text"] = str(format(self.totalt,
                                          ".2f")).replace(".", ",")

        self.lbtsaida["text"] = str(format(self.totalsr3,
                                           ".2f")).replace(".", ",")
        self.lbtentrada["text"] = str(format(self.totalt,
                                             ".2f")).replace(".", ",")
        self.lbttotal["text"] = str(format(self.lbtotalsaldo,
                                           ".2f")).replace(".", ",")
    ...
    def imprimir_relatorio(self, arquivo):
        ...
        btn_imprimir = Button(ask,
                              text="IMPRIMIR",
                              font="arial 12",
                              width=10,
                              command=printer)
        btn_imprimir.place(x=100, y=70)
        btn_cancelar = Button(ask,
                              text="CANCELAR",
                              font="arial 12",
                              width=10,
                              command=ask.destroy)
